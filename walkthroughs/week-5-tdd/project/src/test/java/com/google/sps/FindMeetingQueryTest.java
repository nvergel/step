...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredIncludingOptionalWhoCantAttend() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
  ...
  @Test
  public void everyAttendeeIsConsideredIncludingOptionalWhoCanAttend() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
  ...
  @Test
  public void justEnoughRoomIfOptionalIsIgnored() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
  ...
  @Test
  public void everyOptionalIsConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
